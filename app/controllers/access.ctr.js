 ...
 */
Controller.prototype.model = require('../models/access.mod.js');
...
Controller.prototype.whereCond = function (req) {
    return { $or: [{ oid: { $regex: req.body.search , $options: "i" } }, { name: { $regex: req.body.search , $options: "i" } }] };
};
